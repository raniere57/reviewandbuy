// Men’s Growth Review Specific JavaScript (base: neuroprime/metanail)
...
(function initEntrypoint(){
    const init = () => {
        ...
        initVideoSection("Men’s Growth Male Enhancement Support Review Video");
        initConversionTracking();
        initHeaderButton();
        initMobileMenu();
        loadRelatedReviews('mensgrowth');
    };
...
function trackAffiliateClick(buttonType, buttonText, position){
    console.log('Affiliate Click Tracked:', {buttonType,buttonText,position,product:'Men’s Growth',affiliate_link:'https://857cedjml7-0bz4ejk3evj9r40.hop.clickbank.net',timestamp:new Date().toISOString(),page_url:window.location.href,user_agent:navigator.userAgent});
}
