// HepatoBurn Review Page JavaScript
// Performance optimized for liver fat-burning supplement review
    ...
    stars.forEach((star, index) => {
        setTimeout(() => {
            if (index < Math.floor(targetRating)) {
                ...
                star.style.color = '#fbbf24';
                star.style.clipPath = 'polygon(0 0, 60% 0, 60% 100%, 0% 100%)';
            }
        }, index * 200);
    });
...
function initializeAffiliateTracking() {
    ...
    affiliateLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            trackAffiliateClick('HepatoBurn');
            ...
            setTimeout(() => {
                ...
                this.innerHTML = this.innerHTML.replace('<i class="fas fa-spinner fa-spin"></i> Redirecting...', 'Get HepatoBurn Now');
            }, 1000);
        });
    });
}
...
function trackAffiliateClick(productName) {
    ...
    if (typeof gtag !== 'undefined') {
        gtag('event', 'affiliate_click', {
            ...
            'product_category': 'Liver Health & Weight Loss',
            'event_category': 'E-commerce',
            'event_label': 'HepatoBurn Review'
        });
    }
}
...
function showExitIntentOffer() {
        ...
        <div class="exit-intent-overlay">
            <div class="exit-intent-content">
                ...
                <div class="exit-intent-header">
                    <h3>Wait! Don't Miss Out on Liver Fat-Burning Power</h3>
                </div>
                <div class="exit-intent-body">
                    <p>Get <strong>HepatoBurn</strong> at the best price with our exclusive offer:</p>
                    <div class="exit-intent-offer">
                        ...
                        <div class="offer-benefits">
                            <div class="benefit">✓ Liver Purification Complex</div>
                            <div class="benefit">✓ 60-Day Money Back</div>
                            <div class="benefit">✓ FREE Shipping</div>
                        </div>
                    </div>
                    <a href="https://hop.clickbank.net/?vendor=hepatoburn&affiliate=raniere57&lid=235060" target="_blank" rel="nofollow noopener" class="exit-intent-btn">
                        Get HepatoBurn Now - $49
                    </a>
    ...
    // Track exit intent
    trackAffiliateClick('HepatoBurn - Exit Intent');
}
...
function loadRelatedReviews() {
    ...
    const otherReviews = allReviews.filter(review => review.id !== 'hepatoburn');
