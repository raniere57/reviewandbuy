// Neuro Prime Review Specific JavaScript
...
(function initEntrypoint(){
    const init = () => {
        ...
        initVideoSection('Neuro Prime Brain Health Support Review Video');
        initConversionTracking();
        initHeaderButton();
        initMobileMenu();
        loadRelatedReviews('neuroprime');
    };
...
function trackAffiliateClick(buttonType, buttonText, position){
    console.log('Affiliate Click Tracked:', {buttonType,buttonText,position,product:'Neuro Prime',affiliate_link:'https://76201oqbv8v6731aorsn-bs6oz.hop.clickbank.net',timestamp:new Date().toISOString(),page_url:window.location.href,user_agent:navigator.userAgent});
}
...
function showExitIntentOffer(){
    ...
    <div class="exit-modal-backdrop">
        <div class="exit-modal-content">
            ...
            <p>Get <strong>Neuro Prime</strong> with our <strong>money-back guarantee</strong></p>
            <div class="exit-offer">
                <span class="exit-price">$39</span>
                <span class="exit-guarantee">Risk-Free + Selected FREE Shipping</span>
            </div>
            <a href="https://76201oqbv8v6731aorsn-bs6oz.hop.clickbank.net" target="_blank" class="exit-cta">Claim Your Discount Now</a>
        </div>
    </div>`;
