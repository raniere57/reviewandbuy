// Sumatra Slim Belly Tonic Review Specific JavaScript
...
(function initEntrypoint(){
    const init = () => {
        ...
        initVideoSection('Sumatra Slim Belly Tonic Weight Loss Review Video');
        initConversionTracking();
        initHeaderButton();
        initMobileMenu();
        loadRelatedReviews('sumatraslimbellytonic');
    };
...
function trackAffiliateClick(buttonType, buttonText, position){
    console.log('Affiliate Click Tracked:', {buttonType,buttonText,position,product:'Sumatra Slim Belly Tonic',affiliate_link:'https://996f8oqcv649j66k2kpmscv20y.hop.clickbank.net',timestamp:new Date().toISOString(),page_url:window.location.href,user_agent:navigator.userAgent});
}
...
function showExitIntentOffer(){
    ...
    <div class="exit-modal-backdrop">
        <div class="exit-modal-content">
            ...
            <p>Get <strong>Sumatra Slim Belly Tonic</strong> with our <strong>money-back guarantee</strong></p>
            <div class="exit-offer">
                <span class="exit-price">$39</span>
                <span class="exit-guarantee">Risk-Free + Selected FREE Shipping</span>
            </div>
            <a href="https://996f8oqcv649j66k2kpmscv20y.hop.clickbank.net" target="_blank" class="exit-cta">Claim Your Discount Now</a>
        </div>
    </div>`;
...
function loadRelatedReviews(currentId){
    const all=[
        ...
        {id:'neuroprime',name:'Neuro Prime',rating:4.8,description:'Natural brain health support for cognitive function.',url:'./neuroprime.html',icon:'fas fa-brain'},
        {id:'balmorex',name:'Balmorex',rating:4.7,description:'Natural joint pain relief support for mobility.',url:'./balmorex.html',icon:'fas fa-bone'},
        {id:'neuroquiet',name:'Neuro Quiet',rating:4.8,description:'Natural tinnitus relief support for ear health.',url:'./neuroquiet.html',icon:'fas fa-volume-mute'}
    ];
