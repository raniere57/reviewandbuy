// Ignitra Review Specific JavaScript
...
(function initEntrypoint(){
    const init = () => {
        ...
        initVideoSection('Ignitra Weight Loss Support Review Video');
        initConversionTracking();
        initHeaderButton();
        initMobileMenu();
        loadRelatedReviews('ignitra');
    };
...
function trackAffiliateClick(buttonType, buttonText, position){
    console.log('Affiliate Click Tracked:', {buttonType,buttonText,position,product:'Ignitra',affiliate_link:'https://ca7afqi8udwcj4agjmsm377l9y.hop.clickbank.net',timestamp:new Date().toISOString(),page_url:window.location.href,user_agent:navigator.userAgent});
}
...
function showExitIntentOffer(){
    ...
    <div class="exit-modal-backdrop">
        <div class="exit-modal-content">
            ...
            <p>Get <strong>Ignitra</strong> with our <strong>money-back guarantee</strong></p>
            <div class="exit-offer">
                <span class="exit-price">$39</span>
                <span class="exit-guarantee">Risk-Free + Selected FREE Shipping</span>
            </div>
            <a href="https://ca7afqi8udwcj4agjmsm377l9y.hop.clickbank.net" target="_blank" class="exit-cta">Claim Your Discount Now</a>
        </div>
    </div>`;
...
function loadRelatedReviews(currentId){
    const all=[
        ...
        {id:'sleeplean',name:'Sleep Lean',rating:4.8,description:'Sleep-based weight loss supplement.',url:'./sleeplean.html',icon:'fas fa-moon'},
