// Metanail Review Specific JavaScript
...
(function initEntrypoint(){
    const init = () => {
        ...
        initVideoSection('Metanail Nail Health Support Review Video');
        initConversionTracking();
        initHeaderButton();
        initMobileMenu();
        loadRelatedReviews('metanail');
    };
...
function trackAffiliateClick(buttonType, buttonText, position){
    console.log('Affiliate Click Tracked:', {buttonType,buttonText,position,product:'Metanail',affiliate_link:'https://b6742op8q8xdf12cnec51jws2n.hop.clickbank.net',timestamp:new Date().toISOString(),page_url:window.location.href,user_agent:navigator.userAgent});
}
...
function showExitIntentOffer(){
    ...
    <div class="exit-modal-backdrop">
        <div class="exit-modal-content">
            ...
            <p>Get <strong>Metanail</strong> with our <strong>money-back guarantee</strong></p>
            <div class="exit-offer">
                <span class="exit-price">$59</span>
                <span class="exit-guarantee">Risk-Free + Selected FREE Shipping</span>
            </div>
            <a href="https://b6742op8q8xdf12cnec51jws2n.hop.clickbank.net" target="_blank" class="exit-cta">Claim Your Discount Now</a>
        </div>
    </div>`;
