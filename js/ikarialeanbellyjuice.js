// Ikaria Lean Belly Juice Review Specific JavaScript

(function initEntrypoint(){
    const init = () => {
        initProgressBars();
        initTimelineAnimations();
        initRatingAnimations(4.9);
        initVideoSection('Ikaria Lean Belly Juice Weight Loss Review Video');
        initConversionTracking();
        initHeaderButton();
        initMobileMenu();
        loadRelatedReviews('ikarialeanbellyjuice');
    };
...
function trackAffiliateClick(buttonType, buttonText, position){
    console.log('Affiliate Click Tracked:', {buttonType,buttonText,position,product:'Ikaria Lean Belly Juice',affiliate_link:'https://a20a1dbasdw2c00jr6xfha1o2m.hop.clickbank.net',timestamp:new Date().toISOString(),page_url:window.location.href,user_agent:navigator.userAgent});
}
...
function showExitIntentOffer(){
    ...
    <div class="exit-modal-backdrop">
        <div class="exit-modal-content">
            ...
            <p>Get <strong>Ikaria Lean Belly Juice</strong> with our <strong>money-back guarantee</strong></p>
            <div class="exit-offer">
                <span class="exit-price">$39</span>
                <span class="exit-guarantee">Risk-Free + Selected FREE Shipping</span>
            </div>
            <a href="https://a20a1dbasdw2c00jr6xfha1o2m.hop.clickbank.net" target="_blank" class="exit-cta">Claim Your Discount Now</a>
        </div>
    </div>`;
