// Joint Genesis Review JavaScript
...
function initializeConversionTracking() {
    elements.conversionBtns.forEach(btn => {
        btn.addEventListener('click', function(e) {
            trackAffiliateClick('Joint Genesis', this.href);
...
function trackAffiliateClick(productName, url) {
    ...
    if (typeof gtag !== 'undefined') {
        gtag('event', 'affiliate_click', {
            ...
            'event_label': 'jointgenesis_review'
        });
    }
...
function initializeRelatedReviews() {
    ...
    const relatedReviews = [
        ...
        },
        {
            id: 'prodentim',
            name: 'ProDentim',
            description: 'Revolutionary dental probiotic supplement with 3.5 billion probiotics for teeth and gums health.',
            rating: 4.9,
    ...
    const filteredReviews = relatedReviews.filter(review => review.id !== 'jointgenesis');
...
function showExitIntentOffer() {
    ...
    modal.innerHTML = `
        <div class="exit-intent-content">
            <div class="exit-intent-header">
                <h3>🦴 Wait! Don't Miss Out on Better Joint Health</h3>
                <button class="exit-intent-close">&times;</button>
            </div>
            <div class="exit-intent-body">
                <p>Get <strong>Joint Genesis</strong> at the best price with our exclusive offer:</p>
                <div class="exit-intent-offer">
                    ...
                    <div class="offer-benefits">
                        <div class="benefit">✓ Mobilee® Technology</div>
                        <div class="benefit">✓ 60-Day Money Back</div>
                        <div class="benefit">✓ FREE Shipping</div>
                    </div>
                </div>
                <a href="https://5069cemjq-68cx17ygzon5vs0l.hop.clickbank.net" target="_blank" rel="nofollow noopener" class="exit-intent-btn">
                    Get Joint Genesis Now - Limited Time
                </a>
    ...
    // Track exit intent
    trackAffiliateClick('Joint Genesis Exit Intent', 'https://5069cemjq-68cx17ygzon5vs0l.hop.clickbank.net');
}
